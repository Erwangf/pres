...
\title{Full Title of the Talk} 
\newcommand{\shorttitle}{Short title}

\author{John Smith\inst{1} \and Jean Bombeur\inst{2} \and Igor Le Tractor\inst{3}}
\newcommand{\shortauthor}{J. Smith} % Name to display in the footline
\institute{\inst{1}Centre d'\'Etudes Spatiales de la Biosph\`ere, France \url{john.smith@cesbio.cnes.fr}\\
